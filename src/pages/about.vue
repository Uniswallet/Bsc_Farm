        ...
        <div class="info__about">
          ...
          <div class="info__about-text">Mallsbase.com is a platform that aims to reward the providers of MBASE-BNB liquidity.<br><br>
            ...
            <ul>
              ...
              <li>Daily MBASE Pool Rewards: 25,000 ROOBEE</li>
              <li>Farming Period: 40 days</li>
            </ul>
            <span>MBASE Farm on BurgerSwap (bROOBEE/BURGER)</span>
            <ul>
              <li>Tokens allocated for farming: 1,000,000 MBASE</li>
